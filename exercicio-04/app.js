...
const my3FavvoriteTVShowSeries = ['Simpsons', 'Chaves', 'Black mirror'];
// const sentense = `Minhas 3 séries favoritas são: ${my3FavvoriteTVShowSeries[0]}, ${my3FavvoriteTVShowSeries[1]} e ${my3FavvoriteTVShowSeries[2]}.`
// const sentense = `Minhas 3 séries favoritas são: ${my3FavvoriteTVShowSeries.join(', ').replace(', B', ' e B')}.`
...
// console.log(my3FavvoriteTVShowSeries.length === 3);  correct
...
const isRandonTVShowIncluded = my3FavvoriteTVShowSeries.includes(randomTVShow); // correct
// console.log(isRandonTVShowIncluded);
...
const typeOfsentence = `Ò tipo de dado que a const "IsRandomTVShowIncluded" armazena é: ${typeof isRandonTVShowIncluded}`; // correct
// console.log(typeOfsentence)
...
const moreThanNumberOfCaracters = String(typeOfsentence.length) > numberOfCaracters; // 
console.log(`A string que a "TypeOfSentence armazena tem mais de ${numberOfCaracters} caratteres"? ${moreThanNumberOfCaracters}`); // convert to string using String
...
// console.log(`Todos os ${falsyValues.length}  itens do array 'falsyValues são falsy inclusive o ${falsyValues[2]}`); // correct
...
*/
 ...
 const crazyOperator = null + 1;
 const crazyConvertion = Boolean(crazyOperator);

// console.log(crazyConvertion);
// porque um número maior que zero será sempre true
// correct
...
// console.log(`À soma entre o ${ages[0]} e ${ages[2]} de "ages" é menor ou igual a 92. Essa informação é ${agesSum <= 92}`);
...
// console.log(isNotAString) correct
